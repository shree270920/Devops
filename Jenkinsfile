pipeline {
    ...
    stages {
        ...
        stage('Deploy to Staging') {
            steps {
                sh 'ssh -i /var/lib/jenkins/.ssh/guvi.pem ubuntu@ec2-3-93-210-82.compute-1.amazonaws.com "docker pull shree2000/your-image-name:latest && docker run -d -p 8080:80 shree2000/your-image-name:latest"'
            }
        }
    }
}
