pipeline {
    ...
    stages {
        ...
        stage('Deploy to Staging') {
            steps {
                sh 'ssh -i /var/lib/jenkins/.ssh/guvi.pem ubuntu@ec2-3-93-210-82.compute-1.amazonaws.com ""docker pull shree2000/your-image-name:latest && sudo kill -9 $(sudo lsof -t -i   :8080) && docker run -d -p 8080:8080 shree2000/your-image-name:latest""'
            }
        }
    }
}
